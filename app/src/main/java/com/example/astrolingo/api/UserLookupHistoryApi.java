...
public class UserLookupHistoryApi {
...
//        "vocab_id": "6650fbc5e7d1a9b412345678"
//    }
//
    // Hàm gọi API, dùng context để gọi được các phương thức Android
    public static void addLookUpHistory(HashMap<String, String> params, Context context, String token, Response.Listener<JSONObject> onSuccess, Response.ErrorListener onError) {
        String apiurl = context.getString(R.string.api_key) + "api/look_up_history/addLookUpHistory";

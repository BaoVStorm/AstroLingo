...
public class Register_VerifyEmailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next_button.setOnClickListener(v -> {
            // tắt keyboard
            utilService.hideKeyboard(v, Register_VerifyEmailActivity.this);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, apiRegister,
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            Toast.makeText(Register_VerifyEmailActivity.this, response.getString("msg"), Toast.LENGTH_SHORT).show();
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if(error instanceof ServerError && response != null) {
                            try {
                                ...
                                // thông báo
                                Toast.makeText(Register_VerifyEmailActivity.this, obj.getString("msg"), Toast.LENGTH_SHORT).show();
...
//        Log.e("passs", "passs");
    ...
    private void verifyAccount() {
        ...
        String apiRegister = getString(R.string.api_key) + "api/email_verification/verify";
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            if(response.getBoolean("verified")) {
                                ...
                                startActivity(new Intent(Register_VerifyEmailActivity.this, SuccessActivity.class));
                            }
